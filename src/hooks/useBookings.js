 ...
 * Includes update + delete helpers. Deletion only touches Firestore —
 * station status is derived live so no Sheets sync is needed.
 */
export function useAllBookings() {
  ...
  // Deleting a booking from Firestore is enough — useStationData derives
  // bookedSlots and status live from /bookings, so the station circle
  // updates automatically with no extra writes needed.
