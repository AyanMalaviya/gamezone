...
export default function UpiPaymentModal() {
  const { isOpen, context, step, receipt, error, openPayment, closePayment, pay, retry } = usePaymentStore();
  ...
  useEffect(() => { injectKF(); }, []);
  useEffect(() => { if (isOpen && step === 'form') { setUpiId(''); setTimeout(() => inputRef.current?.focus(), 80); } }, [isOpen, step]);
  ...
  const borderColor = step === 'success' ? 'rgba(34,197,94,0.35)'
    : step === 'failed' ? 'rgba(239,68,68,0.35)'
    : 'rgba(124,58,237,0.3)';
  const glowColor = step === 'success' ? 'rgba(34,197,94,0.15)'
    : step === 'failed' ? 'rgba(239,68,68,0.15)'
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '0.68rem', color: 'rgba(255,255,255,0.35)', letterSpacing: '0.1em', marginTop: 1 }}>
                    SANDBOX · TEST MODE
                  </div>
                </div>
              </div>
              ...
              <div style={{ animation: 'upi-slide 0.2s ease both' }}>
                ...
                <div style={{ marginBottom: 14 }}>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                    {TEST_UPI_IDS.map(id => (
                      <BankChip key={id} id={id} active={upiId === id} onClick={setUpiId} />
                    ))}
                  </div>
                </div>
                ...
                <div style={{ marginBottom: 16 }}>
                  <label style={{
                    ...
                    color: 'rgba(255,255,255,0.4)', letterSpacing: '0.1em', marginBottom: 8,
                  }}>UPI ID</label>
                ...
                >
                  <Zap size={16} /> PAY ₹{amt.toLocaleString('en-IN')}
                </button>
              </div>
            )}
            ...
            {step === 'processing' && (
              <div style={{ textAlign: 'center', padding: '20px 0', animation: 'upi-slide 0.2s ease both' }}>
                <div style={{
                  ...
                  <Loader2 size={28} color="#a78bfa" style={{ animation: 'upi-spin 0.8s linear infinite' }} />
                </div>
                <div style={{
                  fontFamily: "'Rajdhani','Inter',sans-serif",
                  fontSize: '1.1rem', fontWeight: 700, color: '#fff', marginBottom: 6,
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    borderRadius: 99, animation: 'upi-bar 2s ease-in-out forwards',
                  }} />
                </div>
              </div>
            )}
            ...
            {step === 'success' && receipt && (
              <div style={{ animation: 'upi-slide 0.25s ease both' }}>
                <div style={{ textAlign: 'center', marginBottom: 20 }}>
                  ...
                  <div style={{
                    fontFamily: "'Rajdhani','Inter',sans-serif",
                    fontSize: '1.2rem', fontWeight: 800, color: '#4ade80', marginBottom: 4,
                ...
                <div style={{
                  ...
                  {[
                    ...
                    ['Status', 'SUCCESS ✓'],
                    ['Time', new Date(receipt.timestamp).toLocaleTimeString('en-IN')],
                  ].map(([k, v]) => (
                    <div key={k} style={{
            ...
            {step === 'failed' && (
              <div style={{ animation: 'upi-slide 0.25s ease both' }}>
                <div style={{ textAlign: 'center', marginBottom: 20 }}>
                  ...
                  <div style={{
                    fontFamily: "'Rajdhani','Inter',sans-serif",
                    fontSize: '1.1rem', fontWeight: 800, color: '#f87171', marginBottom: 6,
                  }}>Payment Failed</div>
